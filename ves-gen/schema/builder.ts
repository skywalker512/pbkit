...
export function getOptions(nodes?: ast.Node[]): Options {
  if (!nodes) return {};
...
export function getRpcs(statements: ast.Statement[]): Service["rpcs"] {
...
export function getDescription(commentGroups: ast.CommentGroup[]): string {
